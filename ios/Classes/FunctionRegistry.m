...
+ (NSDictionary<NSString *, NSObject <MapMethodHandler> *> *)mapMethodHandler {
    if (!_mapDictionary) {
        _mapDictionary = @{
                ...
                @"marker#updateMarker": [UpdateMarker alloc],
                @"marker#addMarkers": [AddMarkers alloc],
                @"map#addTileOverlay": [AddTileOverlay alloc],
                ...
                @"map#addOverlay": [AddOverlay alloc],
                @"map#zoomToSpan": [ZoomToSpan alloc],
                @"map#changeLatLng": [ChangeLatLng alloc],
                @"map#changeCarToLatLng": [ChangeCarToLatLng alloc],
...
+ (NSDictionary<NSString *, NSObject <SearchMethodHandler> *> *)searchMethodHandler {
    if (!_searchDictionary) {
        _searchDictionary = @{
                ...
                @"search#calculateRidingRoute": [CalculateRidingRoute alloc],
                ...
                // @"search#updatePrivacyShow": [UpdatePrivacyShow alloc],
        };
    }
