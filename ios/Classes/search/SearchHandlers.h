...
// @interface UpdatePrivacyShow : NSObject <SearchMethodHandler, AMapSearchDelegate>
// @end
...
@interface CalculateRidingRoute : NSObject <SearchMethodHandler, AMapSearchDelegate>
@end
