...
// @implementation UpdatePrivacyShow {
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"search#searchGeocode ios端参数: name -> %@, city -> %@", name, city);
...
//    NSInteger latLonType = [paramDic[@"latLonType"] integerValue];
    ...
    DLog(@"search#searchReGeocode ios端参数: point -> %@, radius -> %f, latLonType -> %d", pointJson, radius);
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法map#searchPoiId ios端参数: id -> %@", id);
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法map#searchPoi ios端参数: query -> %@", query);
    UnifiedPoiSearchQuery *request = [UnifiedPoiSearchQuery mj_objectWithKeyValues:query];
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法map#searchPoiPolygon ios端参数: query -> %@", query);
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法map#searchRoutePoiLine ios端参数: query -> %@", query);
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法calculateDriveRoute ios端参数: routePlanParamJson -> %@", routePlanParamJson);
    ...
    AMapDrivingCalRouteSearchRequest *routeQuery = [[AMapDrivingCalRouteSearchRequest alloc] init];
        ...
        routeQuery.showFieldType = AMapDrivingRouteShowFieldTypePolyline;
  
        [_search AMapDrivingV2RouteSearch:routeQuery];
...
@implementation CalculateRidingRoute {
    RoutePlanParam *_routePlanParam;
    AMapSearchAPI *_search;
    FlutterResult _result;
}
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法CalculateRidingRoute ios端参数: routePlanParamJson -> %@", routePlanParamJson);
...
- (void)onMethodCall:(FlutterMethodCall *)call :(FlutterResult)result {
    ...
    DLog(@"方法map#searchBusStation ios端参数: stationName -> %@, city -> %@", stationName, city);
