...
@interface UpdateMarker : NSObject<MapMethodHandler>
@end

@interface AddMarkers : NSObject<MapMethodHandler>
@end

@interface AddTileOverlay : NSObject<MapMethodHandler>
@end
...
@interface AddOverlay : NSObject<MapMethodHandler>
@end
...
@interface ChangeCarToLatLng : NSObject <MapMethodHandler>
@end
