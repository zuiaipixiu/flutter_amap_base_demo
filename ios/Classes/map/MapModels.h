...
/// 是否有自定义气泡标注
@property(nonatomic) BOOL haveBubble;
/// 是否有自定义地址标注
@property(nonatomic) BOOL haveAddressLabel;
///标注气泡内容
@property(nonatomic) NSString *bubbleContent;
///标注地址内容
@property(nonatomic) NSString *addressLabelContent;
...
/// 纹理图片
@property(nonatomic) NSString *customTexture;
