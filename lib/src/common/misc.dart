...
String? toResolutionAware(String assetName) {
  ...
  double _parseScale(String key) {
    ...
    final RegExpMatch? match = _extractRatioRegExp.firstMatch(assetDir.path);
    if (match != null && match.groupCount > 0) return double.parse(match.group(1)!);
  ...
  String? _chooseVariant(
    ...
    for (String candidate in candidates) mapping[_parseScale(candidate)] = candidate;
