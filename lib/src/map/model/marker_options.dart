...
class MarkerOptions {
  ...
  bool? haveAddressLabel;

  ///气泡内容[自研iOS]
  String? bubbleContent;

  ///地址label内容[自研iOS]
  String? addressLabelContent;
  ...
  bool operator ==(Object other) =>
      ...
      other is MarkerOptions &&
          ...
          haveBubble == other.haveBubble &&
          haveAddressLabel == other.haveAddressLabel &&
          bubbleContent == other.bubbleContent &&
          addressLabelContent == other.addressLabelContent;

  @override
  int get hashCode => icon.hashCode ^ icons.hashCode ^ alpha.hashCode ^ anchorU.hashCode ^ anchorV.hashCode ^ draggable.hashCode ^ infoWindowEnable.hashCode ^ period.hashCode ^ position.hashCode ^ rotateAngle.hashCode ^ isFlat.hashCode ^ isGps.hashCode ^ infoWindowOffsetX.hashCode ^ infoWindowOffsetY.hashCode ^ snippet.hashCode ^ title.hashCode ^ visible.hashCode ^ autoOverturnInfoWindow.hashCode ^ zIndex.hashCode ^ displayLevel.hashCode ^ belowMaskLayer.hashCode ^ lockedToScreen.hashCode ^ lockedScreenPoint.hashCode ^ customCalloutView.hashCode ^ enabled.hashCode ^ highlighted.hashCode ^ selected.hashCode ^ leftCalloutAccessoryView.hashCode ^ rightCalloutAccessoryView.hashCode ^ haveBubble.hashCode ^ haveAddressLabel.hashCode ^ bubbleContent.hashCode ^ addressLabelContent.hashCode;
