...
class PolylineOptions {
  ...
  @override
  String toString() {
    return 'PolylineOptions{latLngList: $latLngList, width: $width, color: $color, zIndex: $zIndex, isVisible: $isVisible, isDottedLine: $isDottedLine, isGeodesic: $isGeodesic, dottedLineType: $dottedLineType, lineCapType: $lineCapType, lineJoinType: $lineJoinType, isUseGradient: $isUseGradient, isUseTexture: $isUseTexture, customTexture: $customTexture}';
  }
}
