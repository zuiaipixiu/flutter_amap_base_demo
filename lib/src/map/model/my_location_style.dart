...
class MyLocationStyle {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MyLocationStyle && runtimeType == other.runtimeType && myLocationIcon == other.myLocationIcon && anchorU == other.anchorU && anchorV == other.anchorV && radiusFillColor == other.radiusFillColor && strokeColor == other.strokeColor && strokeWidth == other.strokeWidth && myLocationType == other.myLocationType && interval == other.interval && showMyLocation == other.showMyLocation && showsAccuracyRing == other.showsAccuracyRing && showsHeadingIndicator == other.showsHeadingIndicator && locationDotBgColor == other.locationDotBgColor && locationDotFillColor == other.locationDotFillColor && enablePulseAnnimation == other.enablePulseAnnimation && image == other.image;

  @override
  int get hashCode => myLocationIcon.hashCode ^ anchorU.hashCode ^ anchorV.hashCode ^ radiusFillColor.hashCode ^ strokeColor.hashCode ^ strokeWidth.hashCode ^ myLocationType.hashCode ^ interval.hashCode ^ showMyLocation.hashCode ^ showsAccuracyRing.hashCode ^ showsHeadingIndicator.hashCode ^ locationDotBgColor.hashCode ^ locationDotFillColor.hashCode ^ enablePulseAnnimation.hashCode ^ image.hashCode;
