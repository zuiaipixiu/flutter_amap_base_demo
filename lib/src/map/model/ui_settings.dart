...
class UiSettings {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is UiSettings && runtimeType == other.runtimeType && isZoomControlsEnabled == other.isZoomControlsEnabled && zoomPosition == other.zoomPosition && isCompassEnabled == other.isCompassEnabled && isMyLocationButtonEnabled == other.isMyLocationButtonEnabled && isScaleControlsEnabled == other.isScaleControlsEnabled && logoPosition == other.logoPosition && isZoomGesturesEnabled == other.isZoomGesturesEnabled && isScrollGesturesEnabled == other.isScrollGesturesEnabled && isRotateGesturesEnabled == other.isRotateGesturesEnabled && isTiltGesturesEnabled == other.isTiltGesturesEnabled;

  @override
  int get hashCode => isZoomControlsEnabled.hashCode ^ zoomPosition.hashCode ^ isCompassEnabled.hashCode ^ isMyLocationButtonEnabled.hashCode ^ isScaleControlsEnabled.hashCode ^ logoPosition.hashCode ^ isZoomGesturesEnabled.hashCode ^ isScrollGesturesEnabled.hashCode ^ isRotateGesturesEnabled.hashCode ^ isTiltGesturesEnabled.hashCode;
