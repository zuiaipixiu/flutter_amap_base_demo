...
class Location {
  ...
  @override
  int get hashCode => accuracy.hashCode ^ adCode.hashCode ^ address.hashCode ^ altitude.hashCode ^ aoiName.hashCode ^ bearing.hashCode ^ buildingId.hashCode ^ city.hashCode ^ cityCode.hashCode ^ coordType.hashCode ^ country.hashCode ^ district.hashCode ^ errorCode.hashCode ^ errorInfo.hashCode ^ floor.hashCode ^ gpsAccuracyStatus.hashCode ^ isFixLastLocation.hashCode ^ isMock.hashCode ^ isOffset.hashCode ^ latitude.hashCode ^ locationDetail.hashCode ^ locationQualityReport.hashCode ^ locationType.hashCode ^ longitude.hashCode ^ poiName.hashCode ^ provider.hashCode ^ province.hashCode ^ satellites.hashCode ^ speed.hashCode ^ street.hashCode ^ streetNum.hashCode ^ trustedLevel.hashCode;
...
class LocationQualityReport {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is LocationQualityReport && runtimeType == other.runtimeType && adviseMessage == other.adviseMessage && gpsSatellites == other.gpsSatellites && gpsStatus == other.gpsStatus && isWifiAble == other.isWifiAble && netUseTime == other.netUseTime && networkType == other.networkType;

  @override
  int get hashCode => adviseMessage.hashCode ^ gpsSatellites.hashCode ^ gpsStatus.hashCode ^ isWifiAble.hashCode ^ netUseTime.hashCode ^ networkType.hashCode;
