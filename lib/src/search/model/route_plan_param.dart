...
class RoutePlanParam {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is RoutePlanParam && runtimeType == other.runtimeType && from == other.from && to == other.to && mode == other.mode && passedByPoints == other.passedByPoints && avoidPolygons == other.avoidPolygons && avoidRoad == other.avoidRoad;

  @override
  int get hashCode => from.hashCode ^ to.hashCode ^ mode.hashCode ^ passedByPoints.hashCode ^ avoidPolygons.hashCode ^ avoidRoad.hashCode;
