...
class GeocodeResult {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GeocodeResult && runtimeType == other.runtimeType && geocodeAddressList == other.geocodeAddressList && geocodeQuery == other.geocodeQuery;
...
class GeocodeAddressList {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GeocodeAddressList && runtimeType == other.runtimeType && adcode == other.adcode && building == other.building && city == other.city && district == other.district && formatAddress == other.formatAddress && latLng == other.latLng && level == other.level && neighborhood == other.neighborhood && province == other.province && township == other.township;

  @override
  int get hashCode => adcode.hashCode ^ building.hashCode ^ city.hashCode ^ district.hashCode ^ formatAddress.hashCode ^ latLng.hashCode ^ level.hashCode ^ neighborhood.hashCode ^ province.hashCode ^ township.hashCode;
...
class GeocodeQuery {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is GeocodeQuery && runtimeType == other.runtimeType && city == other.city && locationName == other.locationName;
