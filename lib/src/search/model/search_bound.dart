...
class SearchBound {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchBound && runtimeType == other.runtimeType && lowerLeft == other.lowerLeft && upperRight == other.upperRight && center == other.center && range == other.range && shape == other.shape && isDistanceSort == other.isDistanceSort && polyGonList == other.polyGonList;

  @override
  int get hashCode => lowerLeft.hashCode ^ upperRight.hashCode ^ center.hashCode ^ range.hashCode ^ shape.hashCode ^ isDistanceSort.hashCode ^ polyGonList.hashCode;
