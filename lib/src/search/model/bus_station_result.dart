...
//    });
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.searchSuggestionCities != null) {
      data['searchSuggestionCities'] = this.searchSuggestionCities?.map((v) => v.toJson()).toList();
    }
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BusStationResult && runtimeType == other.runtimeType && busStations == other.busStations && pageCount == other.pageCount && query == other.query && searchSuggestionCities == other.searchSuggestionCities && searchSuggestionKeywords == other.searchSuggestionKeywords;

  @override
  int get hashCode => busStations.hashCode ^ pageCount.hashCode ^ query.hashCode ^ searchSuggestionCities.hashCode ^ searchSuggestionKeywords.hashCode;
...
class BusStation {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BusStation && runtimeType == other.runtimeType && adCode == other.adCode && busLineItems == other.busLineItems && busStationId == other.busStationId && busStationName == other.busStationName && cityCode == other.cityCode && latLng == other.latLng;

  @override
  int get hashCode => adCode.hashCode ^ busLineItems.hashCode ^ busStationId.hashCode ^ busStationName.hashCode ^ cityCode.hashCode ^ latLng.hashCode;
...
class BusLineItem {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is BusLineItem && runtimeType == other.runtimeType && basicPrice == other.basicPrice && bounds == other.bounds && busLineId == other.busLineId && busLineName == other.busLineName && busLineType == other.busLineType && busStations == other.busStations && cityCode == other.cityCode && distance == other.distance && originatingStation == other.originatingStation && terminalStation == other.terminalStation && totalPrice == other.totalPrice;

  @override
  int get hashCode => basicPrice.hashCode ^ bounds.hashCode ^ busLineId.hashCode ^ busLineName.hashCode ^ busLineType.hashCode ^ busStations.hashCode ^ cityCode.hashCode ^ distance.hashCode ^ originatingStation.hashCode ^ terminalStation.hashCode ^ totalPrice.hashCode;
...
class Query {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Query && runtimeType == other.runtimeType && city == other.city && pageNumber == other.pageNumber && pageSize == other.pageSize && queryString == other.queryString;
