...
public class NotifyUtils {
    public static final int NOTIFY_ID = 2004;
    ...
    public static Notification buildNotification(Context context) {
        try {
            ...
            if (android.os.Build.VERSION.SDK_INT >= 26) {
                ...
                System.out.println( "notifyuitls getid ");
                String channelId = mContext.getPackageName();
                System.out.println( "notifyuitls getid yes ");
                if (!isCreatedChannel) {
...
//                    isCreatedChannel = true;
            ...
            System.out.println( "notifyuitls error: ");
            e.printStackTrace();
        }
        return null;
    }
