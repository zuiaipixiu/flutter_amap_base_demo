...
object UpdatePrivacyShow : SearchMethodHandler {
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        ...
        log("方法map#UpdatePrivacyShow android端参数: query -> updatePrivacyShow updatePrivacyAgree")
        result.success("");
    }
}
...
object CalculateRidingRoute : SearchMethodHandler {
