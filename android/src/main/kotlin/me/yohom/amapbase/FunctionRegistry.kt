...
import me.yohom.amapbase.location.UnbindService
import me.yohom.amapbase.map.*
import me.yohom.amapbase.navi.handler.*
...
val MAP_METHOD_HANDLER: Map<String, MapMethodHandler> = mapOf(
        ...
        "map#addTileOverlay" to AddTileOverlay,
        "marker#addMarker" to AddMarker,
        "marker#updateMarker" to UpdateMarker,
...
val SEARCH_METHOD_HANDLER: Map<String, SearchMethodHandler> = mapOf(
        ...
        "search#calculateRidingRoute" to CalculateRidingRoute,
...
val NAVI_METHOD_HANDLER: Map<String, NaviMethodHandler> = mapOf(
        ...
        "nav#stopCustomeNavi" to StopCustomNavi,
        // "nav#CustomSpeak" to CustomSpeak,
        "nav#destroyCustomeNavi" to DestroyCustomNavi,
        "nav#changeMapRouteNaviWithInfo" to ChangeMapRouteNaviWithInfo
)
...
val LOCATION_METHOD_HANDLER: Map<String, LocationMethodHandler> = mapOf(
        ...
        "location#unbindService" to UnbindService
)
